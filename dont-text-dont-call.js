...
// Main melody
$: note("[72 71 71 71 72 74 74 74 74 74 72 72 72 71 71 71 72 74 76 76 76 76 72 72]/16").sound("gm_tremolo_strings").gain(0.6).room(1).decay(0.6).lpf(4000)._punchcard();
// Main melody support
